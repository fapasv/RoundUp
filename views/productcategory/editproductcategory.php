<div class="modal-header">
  <h5 class="modal-title" id="exampleModalLongTitle">Modificar categoría de producto</h5>
...
<form role="form">
  ...
  <div class="modal-footer">
    ...
    <button type="submit" class="btn btn-danger btn-noround"><span class="fa fa-times"></span> Modificar</button>
  </div>
</form>
