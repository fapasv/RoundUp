<div class="modal-header">
  <h5 class="modal-title" id="exampleModalLongTitle">Contactos de proveedor</h5>
...
<form role="form">
  <div class="modal-body">
    <div class="row">
      <div class="form-group col-md-2">
        <input type="text" class="form-control" id="inputPtoveedor" placeholder="Proveedor">
      </div>
  ...
  <div class="modal-footer" style="text-align: center">
    <button type="button" class="btn btn-danger btn-noround"><span class="fa fa-plus"></span> Agregar</button>
  </div>
</form>
